...
#public IP must be added to firewall whitelist "curl ifconfig.co" (using AWS us-east-1 default SG in this example)
...
#this instance won't work unless we get a service running and listening on port 3400. install python with "sudo apt-get install python" and execute: "python helloworld.py &" to launch it in the background
